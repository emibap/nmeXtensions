...
::com::emibap::mailsendersample::MailSenderSample_obj::__register();
::Type_obj::__register();
...
::Type_obj::__boot();
::com::emibap::mailsendersample::MailSenderSample_obj::__boot();
