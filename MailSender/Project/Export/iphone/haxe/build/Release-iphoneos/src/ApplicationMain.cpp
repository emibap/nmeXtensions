...
Void ApplicationMain_obj::main( ){
{
		...
		::nme::Lib_obj::setPackage(HX_CSTRING("Emiliano Angelini"),HX_CSTRING("MailSenderSample"),HX_CSTRING("com.emibap.mailsendersample"),HX_CSTRING("1.0.0"));
		...
		Void run(){
{
				...
				::com::emibap::mailsendersample::MailSenderSample_obj::main();
			}
			return null();
		}
		...
		::nme::Lib_obj::create( Dynamic(new _Function_1_2()),(int)640,(int)960,(int)30,(int)16777215,(int((int((int(::nme::Lib_obj::HARDWARE) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0)),HX_CSTRING("MailSender Sample"),null());
	}
return null();
}
