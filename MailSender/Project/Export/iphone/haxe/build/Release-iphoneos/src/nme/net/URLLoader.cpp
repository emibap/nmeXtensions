...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",59)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",60)
	this->nmeHandle = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",61)
	this->bytesLoaded = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",62)
	this->bytesTotal = (int)-1;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",63)
	this->state = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",64)
	this->dataFormat = ::nme::net::URLLoaderDataFormat_obj::TEXT_dyn();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",65)
	if (((request != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",66)
		this->load(request);
	}
}
;
...
Array< ::String > URLLoader_obj::getCookies( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",77)
...
Void URLLoader_obj::load( ::nme::net::URLRequest request){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",96)
		this->state = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",97)
		::String pref = request->url.substr((int)0,(int)7);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",98)
		if (((bool((pref != HX_CSTRING("http://"))) && bool((pref != HX_CSTRING("https:/")))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",100)
			try{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",101)
				::nme::utils::ByteArray bytes = ::nme::utils::ByteArray_obj::readFile(request->url);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",102)
				{
::nme::net::URLLoaderDataFormat _switch_1 = (this->dataFormat);
					switch((_switch_1)->GetIndex()){
						case 1: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",104)
							this->data = bytes->asString();
						}
						;break;
						case 2: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",106)
							this->data = ::nme::net::URLVariables_obj::__new(bytes->asString());
						}
						;break;
						default: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",108)
							this->data = bytes;
						}
					}
				}
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",114)
						this->onError(e);
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",115)
						return null();
					}
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",118)
			this->nmeDataComplete();
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",122)
			request->nmePrepare();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",123)
			this->nmeHandle = ::nme::net::URLLoader_obj::nme_curl_create(request);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",124)
			if (((this->nmeHandle == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",125)
				this->onError(HX_CSTRING("Could not open URL"));
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",129)
...
Void URLLoader_obj::nmeDataComplete( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",134)
		if (((this->nmeOnComplete_dyn() != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",136)
			if ((this->nmeOnComplete(this->data))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",138)
				this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",140)
				this->DispatchIOErrorEvent();
			}
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",143)
			this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
		}
	}
return null();
...
Void URLLoader_obj::onError( ::String msg){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",180)
...
Void URLLoader_obj::update( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",186)
		if (((this->nmeHandle != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",189)
			int old_loaded = this->bytesLoaded;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",190)
			int old_total = this->bytesTotal;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",191)
			::nme::net::URLLoader_obj::nme_curl_update_loader(this->nmeHandle,hx::ObjectPtr<OBJ_>(this));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",192)
			if (((bool((old_total < (int)0)) && bool((this->bytesTotal > (int)0))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",193)
				this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::OPEN,null(),null()));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",197)
			if (((bool((this->bytesTotal > (int)0)) && bool((this->bytesLoaded != old_loaded))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",198)
				this->dispatchEvent(::nme::events::ProgressEvent_obj::__new(HX_CSTRING("progress"),false,false,this->bytesLoaded,this->bytesTotal));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",202)
			int code = ::nme::net::URLLoader_obj::nme_curl_get_code(this->nmeHandle);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",203)
			if (((this->state == (int)3))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",204)
				if (((code < (int)400))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",207)
					::nme::utils::ByteArray bytes = ::nme::net::URLLoader_obj::nme_curl_get_data(this->nmeHandle);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",208)
					{
::nme::net::URLLoaderDataFormat _switch_2 = (this->dataFormat);
						switch((_switch_2)->GetIndex()){
							case 1: case 2: {
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",210)
								this->data = (  (((bytes == null()))) ? ::String(HX_CSTRING("")) : ::String(bytes->asString()) );
							}
							;break;
							default: {
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",212)
								this->data = bytes;
							}
						}
					}
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",215)
					this->nmeDataComplete();
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",220)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",221)
					this->nmeHandle = null();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",222)
					this->dispatchEvent(evt);
				}
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",225)
				if (((this->state == (int)4))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",227)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",228)
					this->nmeHandle = null();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",229)
					this->dispatchEvent(evt);
				}
			}
		}
...
bool URLLoader_obj::hasActive( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",83)
...
Void URLLoader_obj::initialize( ::String inCACertFilePath){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",89)
...
bool URLLoader_obj::nmeLoadPending( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",154)
	return !(::nme::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
Void URLLoader_obj::nmePollData( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",163)
		if ((!(::nme::net::URLLoader_obj::activeLoaders->isEmpty()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",166)
			::nme::net::URLLoader_obj::nme_curl_process_loaders();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",167)
			::List oldLoaders = ::nme::net::URLLoader_obj::activeLoaders;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",168)
			::nme::net::URLLoader_obj::activeLoaders = ::List_obj::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",169)
			for(::cpp::FastIterator_obj< ::nme::net::URLLoader > *__it = ::cpp::CreateFastIterator< ::nme::net::URLLoader >(oldLoaders->iterator());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",171)
					loader->update();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",172)
					if (((loader->state == (int)2))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLLoader.hx",173)
