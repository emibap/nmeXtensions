...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",33)
	if (((inURL != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",34)
		this->url = inURL;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",35)
	this->verbose = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",36)
	this->userPassword = HX_CSTRING("");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",37)
	this->cookieString = HX_CSTRING("");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",38)
	this->authType = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",39)
	this->contentType = HX_CSTRING("application/x-www-form-urlencoded");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",40)
...
Void URLRequest_obj::basicAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",46)
		this->authType = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",47)
...
Void URLRequest_obj::digestAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",53)
		this->authType = (int)2;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",54)
		this->userPassword = ((inUser + HX_CSTRING(":")) + inPasswd);
	}
return null();
}
...
Void URLRequest_obj::nmePrepare( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",62)
		if (((this->data == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",64)
			this->nmeBytes = null();
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",66)
			if ((::Std_obj::is(this->data,hx::ClassOf< ::nme::utils::ByteArray >()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",68)
				this->nmeBytes = this->data;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",69)
				if ((::Std_obj::is(this->data,hx::ClassOf< ::nme::net::URLVariables >()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",71)
					::nme::net::URLVariables vars = this->data;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",72)
					::String str = vars->toString();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",73)
					this->nmeBytes = ::nme::utils::ByteArray_obj::__new(null());
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",74)
					this->nmeBytes->writeUTFBytes(str);
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",76)
					if ((::Std_obj::is(this->data,hx::ClassOf< ::String >()))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",78)
						::String str = this->data;
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",79)
						this->nmeBytes = ::nme::utils::ByteArray_obj::__new(null());
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",80)
						this->nmeBytes->writeUTFBytes(str);
					}
					else{
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/net/URLRequest.hx",83)
