class ApplicationMain
{
	...
	{
		nme.Lib.setPackage("Emiliano Angelini", "LocationManagerSample", "com.emibap.locationmanagersample", "1.0.0");
		...
		nme.Lib.create(function()
			{
				...
				com.emibap.locationmanagersample.LocationManagerSample.main();
			},
			640, 960,
			30,
			0xffffff,
