...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",27)
...
Void Graphics_obj::arcTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",33)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",39)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",45)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",52)
		if (((matrix == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",54)
			matrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",55)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",58)
...
Void Graphics_obj::clear( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",63)
...
Void Graphics_obj::curveTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",69)
...
Void Graphics_obj::drawCircle( double inX,double inY,double inRadius){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",75)
...
Void Graphics_obj::drawEllipse( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",81)
...
Void Graphics_obj::drawGraphicsData( Array< ::nme::display::IGraphicsData > graphicsData){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",88)
		Dynamic handles = Dynamic( Array_obj<Dynamic>::__new() );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",90)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",90)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",90)
			while(((_g < graphicsData->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",90)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",91)
				handles->__Field(HX_CSTRING("push"))(datum->nmeHandle);
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",93)
...
Void Graphics_obj::drawGraphicsDatum( ::nme::display::IGraphicsData graphicsDatum){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",98)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",104)
...
Void Graphics_obj::drawRect( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",110)
...
Void Graphics_obj::drawRoundRect( double inX,double inY,double inWidth,double inHeight,double inRadX,Dynamic inRadY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",116)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",126)
		this->beginBitmapFill(sheet->nmeBitmap,null(),false,inSmooth);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",128)
		if ((inSmooth)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",129)
			hx::OrEq(inFlags,(int)4096);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",131)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",137)
		int cull = (  (((culling == null()))) ? int((int)0) : int((culling->__Index() - (int)1)) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",138)
...
Void Graphics_obj::endFill( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",143)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",149)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",156)
		if (((matrix == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",158)
			matrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",159)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",162)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",167)
...
Void Graphics_obj::lineTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",173)
...
Void Graphics_obj::moveTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",179)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Graphics.hx",185)
