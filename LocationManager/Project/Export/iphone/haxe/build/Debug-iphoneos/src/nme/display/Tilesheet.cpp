...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Tilesheet.hx",49)
	this->nmeBitmap = inImage;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Tilesheet.hx",53)
...
Void Tilesheet_obj::addTileRect( ::nme::geom::Rectangle rectangle,::nme::geom::Point centerPoint){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Tilesheet.hx",73)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Tilesheet.hx",171)
