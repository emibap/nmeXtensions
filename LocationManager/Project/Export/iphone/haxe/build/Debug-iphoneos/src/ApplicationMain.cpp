...
Void ApplicationMain_obj::main( ){
{
		...
		::nme::Lib_obj::setPackage(HX_CSTRING("Emiliano Angelini"),HX_CSTRING("LocationManagerSample"),HX_CSTRING("com.emibap.locationmanagersample"),HX_CSTRING("1.0.0"));

		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
		bool run(int orientation){
{
				HX_SOURCE_POS("ApplicationMain.hx",12)
				if (((bool((orientation == ::nme::display::Stage_obj::OrientationPortrait)) || bool((orientation == ::nme::display::Stage_obj::OrientationPortraitUpsideDown))))){
		...
		Void run(){
{
				...
				::com::emibap::locationmanagersample::LocationManagerSample_obj::main();
			}
			return null();
		}
		...
		::nme::Lib_obj::create( Dynamic(new _Function_1_2()),(int)640,(int)960,(int)30,(int)16777215,(int((int((int(::nme::Lib_obj::HARDWARE) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0)),HX_CSTRING("LocationManager Sample"),null());
	}
return null();
}
