...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",86)
	super::__construct(inHandle,HX_CSTRING("Stage"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",87)
	this->nmeMouseOverObjects = Array_obj< ::nme::display::InteractiveObject >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",88)
	this->nmeFocusOverObjects = Array_obj< ::nme::display::InteractiveObject >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",89)
	this->active = true;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",90)
	this->pauseWhenDeactivated = true;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",95)
	this->renderRequest = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",98)
	::nme::display::Stage_obj::nme_set_stage_handler(this->nmeHandle,this->nmeProcessStageEvent_dyn(),inWidth,inHeight);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",99)
	this->nmeInvalid = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",100)
	this->nmeLastRender = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",101)
	this->nmeLastDown = Array_obj< ::nme::display::InteractiveObject >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",102)
	this->nmeLastClickTime = 0.0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",103)
	this->nmeSetFrameRate((int)100);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",104)
	this->nmeTouchInfo = ::IntHash_obj::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",105)
...
Void Stage_obj::invalidate( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",116)
...
Void Stage_obj::nmeCheckFocusInOuts( Dynamic inEvent,Array< ::nme::display::InteractiveObject > inStack){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",124)
		int new_n = inStack->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",125)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",126)
		int old_n = this->nmeFocusOverObjects->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",127)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",129)
		if (((new_obj != old_obj))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",132)
			int common = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",133)
			while(((bool((bool((common < new_n)) && bool((common < old_n)))) && bool((inStack->__get(common) == this->nmeFocusOverObjects->__get(common)))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",134)
				(common)++;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",136)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",138)
			int i = (old_n - (int)1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",139)
			while(((i >= common))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",141)
				this->nmeFocusOverObjects->__get(i)->nmeDispatchEvent(focusOut);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",142)
				(i)--;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",145)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",146)
			int i1 = (new_n - (int)1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",148)
			while(((i1 >= common))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",150)
				inStack->__get(i1)->nmeDispatchEvent(focusIn);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",151)
				(i1)--;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",154)
...
bool Stage_obj::nmeCheckInOuts( ::nme::events::MouseEvent inEvent,Array< ::nme::display::InteractiveObject > inStack,::nme::display::TouchInfo touchInfo){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",161)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",162)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",164)
	int new_n = inStack->length;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",165)
	::nme::display::InteractiveObject new_obj = (  (((new_n > (int)0))) ? ::nme::display::InteractiveObject(inStack->__get((new_n - (int)1))) : ::nme::display::InteractiveObject(null()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",166)
	int old_n = prev->length;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",167)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",169)
	if (((new_obj != old_obj))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",172)
		if (((old_obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",173)
			old_obj->nmeFireEvent(inEvent->nmeCreateSimilar(events->__get((int)0),new_obj,old_obj));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",175)
		if (((new_obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",176)
			new_obj->nmeFireEvent(inEvent->nmeCreateSimilar(events->__get((int)1),old_obj,null()));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",179)
		int common = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",180)
		while(((bool((bool((common < new_n)) && bool((common < old_n)))) && bool((inStack->__get(common) == prev->__get(common)))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",181)
			(common)++;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",183)
		::nme::events::MouseEvent rollOut = inEvent->nmeCreateSimilar(events->__get((int)2),new_obj,old_obj);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",184)
		int i = (old_n - (int)1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",185)
		while(((i >= common))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",187)
			prev->__get(i)->nmeDispatchEvent(rollOut);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",188)
			(i)--;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",191)
		::nme::events::MouseEvent rollOver = inEvent->nmeCreateSimilar(events->__get((int)3),old_obj,null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",192)
		int i1 = (new_n - (int)1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",193)
		while(((i1 >= common))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",195)
			inStack->__get(i1)->nmeDispatchEvent(rollOver);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",196)
			(i1)--;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",199)
		if (((touchInfo == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",200)
			this->nmeMouseOverObjects = inStack;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",202)
			touchInfo->touchOverObjects = inStack;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",204)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",207)
	return true;
}
...
Void Stage_obj::nmeCheckRender( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",212)
		if (((this->frameRate > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",216)
			double now = ::haxe::Timer_obj::stamp();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",217)
			if (((now >= (this->nmeLastRender + this->nmeFramePeriod)))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",219)
				this->nmeLastRender = now;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",220)
				if (((this->renderRequest_dyn() != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",221)
					this->renderRequest();
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",223)
					this->nmeRender(true);
				}
			}
		}
...
double Stage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",231)
	double result = 0.0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",233)
	int type = ::Std_obj::_int(::Reflect_obj::field(inEvent,HX_CSTRING("type")));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",235)
	switch( (int)(type)){
		case (int)2: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",237)
			if (((this->onKey_dyn() != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",239)
		...
		;break;
		case (int)1: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",241)
			this->nmeOnKey(inEvent,::nme::events::KeyboardEvent_obj::KEY_DOWN);
		}
		;break;
		case (int)3: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",244)
			this->nmeOnKey(inEvent,::nme::events::KeyboardEvent_obj::KEY_UP);
		}
		;break;
		case (int)4: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",247)
			this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::MOUSE_MOVE,true);
		}
		;break;
		case (int)5: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",250)
			this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::MOUSE_DOWN,true);
		}
		;break;
		case (int)6: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",253)
			this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::CLICK,true);
		}
		;break;
		case (int)7: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",256)
			this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::MOUSE_UP,true);
		}
		;break;
		case (int)8: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",260)
			this->nmeOnResize(inEvent->__Field(HX_CSTRING("x")),inEvent->__Field(HX_CSTRING("y")));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",261)
			if (((this->renderRequest_dyn() == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",262)
				this->nmeRender(false);
			}
		}
		;break;
		case (int)9: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",264)
			this->nmePollTimers();
		}
		;break;
		case (int)10: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",267)
			if (((this->onQuit_dyn() != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",269)
				this->onQuit();
			}
		}
		;break;
		case (int)11: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",271)
			this->nmeOnFocus(inEvent);
		}
		;break;
		case (int)12: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",274)
			if ((::nme::display::Stage_obj::shouldRotateInterface(inEvent->__Field(HX_CSTRING("value"))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",276)
				inEvent->__FieldRef(HX_CSTRING("result")) = (int)2;
			}
		}
		;break;
		case (int)14: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",278)
			this->nmeRender(true);
		}
		;break;
		case (int)15: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",282)
			::nme::display::TouchInfo touchInfo = ::nme::display::TouchInfo_obj::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",283)
			this->nmeTouchInfo->set(inEvent->__Field(HX_CSTRING("value")),touchInfo);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",284)
			this->nmeOnTouch(inEvent,::nme::events::TouchEvent_obj::TOUCH_BEGIN,touchInfo);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",286)
			if (((((int(inEvent->__Field(HX_CSTRING("flags"))) & int((int)32768))) > (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",287)
				this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::MOUSE_DOWN,false);
			}
		}
		;break;
		case (int)16: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",290)
			::nme::display::TouchInfo touchInfo = this->nmeTouchInfo->get(inEvent->__Field(HX_CSTRING("value")));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",291)
			this->nmeOnTouch(inEvent,::nme::events::TouchEvent_obj::TOUCH_MOVE,touchInfo);
		}
		;break;
		case (int)17: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",294)
			::nme::display::TouchInfo touchInfo = this->nmeTouchInfo->get(inEvent->__Field(HX_CSTRING("value")));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",295)
			this->nmeOnTouch(inEvent,::nme::events::TouchEvent_obj::TOUCH_END,touchInfo);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",296)
			this->nmeTouchInfo->remove(inEvent->__Field(HX_CSTRING("value")));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",298)
			if (((((int(inEvent->__Field(HX_CSTRING("flags"))) & int((int)32768))) > (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",299)
		...
		;break;
		case (int)19: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",304)
			this->nmeOnChange(inEvent);
		}
		;break;
		case (int)20: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",307)
			this->nmeSetActive(true);
		}
		;break;
		case (int)21: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",310)
			this->nmeSetActive(false);
		}
		;break;
		case (int)22: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",314)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::GOT_INPUT_FOCUS,null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",315)
			this->nmeBroadcast(evt);
		}
		;break;
		case (int)23: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",318)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::LOST_INPUT_FOCUS,null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",319)
			this->nmeBroadcast(evt);
		}
		;break;
		case (int)24: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",321)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::AXIS_MOVE);
		}
		;break;
		case (int)25: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",324)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::BALL_MOVE);
		}
		;break;
		case (int)26: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",327)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::HAT_MOVE);
		}
		;break;
		case (int)27: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",330)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::BUTTON_DOWN);
		}
		;break;
		case (int)28: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",333)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::BUTTON_UP);
		}
		;break;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",339)
	result = this->nmeUpdateNextWake();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",342)
	return result;
}
...
Void Stage_obj::dummyTrace( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",345)
...
Dynamic Stage_obj::nmeProcessStageEvent( Dynamic inEvent){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",353)
	this->nmeDoProcessStageEvent(inEvent);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",354)
	return null();
}
...
Void Stage_obj::nmeDrag( ::nme::geom::Point inMouse){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",360)
		::nme::display::DisplayObjectContainer p = this->nmeDragObject->nmeGetParent();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",361)
		if (((p != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",362)
			inMouse = p->globalToLocal(inMouse);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",364)
		double x = (inMouse->x + this->nmeDragOffsetX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",365)
		double y = (inMouse->y + this->nmeDragOffsetY);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",367)
		if (((this->nmeDragBounds != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",369)
			if (((x < this->nmeDragBounds->x))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",369)
				x = this->nmeDragBounds->x;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",370)
				if (((x > this->nmeDragBounds->nmeGetRight()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",370)
					x = this->nmeDragBounds->nmeGetRight();
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",372)
			if (((y < this->nmeDragBounds->y))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",372)
				y = this->nmeDragBounds->y;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",373)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",376)
		this->nmeDragObject->nmeSetX(x);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",377)
...
::nme::display::Stage Stage_obj::nmeGetStage( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",385)
...
double Stage_obj::nmeNextFrameDue( double inOtherTimers){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",392)
	if (((bool(!(this->active)) && bool(this->pauseWhenDeactivated)))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",393)
		return inOtherTimers;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",394)
	if (((this->frameRate > (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",396)
		double next = (((this->nmeLastRender + this->nmeFramePeriod) - ::haxe::Timer_obj::stamp()) - ::nme::display::Stage_obj::nmeEarlyWakeup);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",397)
		if (((next < inOtherTimers))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",398)
			return next;
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",400)
	return inOtherTimers;
}
...
Void Stage_obj::nmeOnChange( Dynamic inEvent){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",406)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id")));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",407)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",408)
...
Void Stage_obj::nmeOnFocus( Dynamic inEvent){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",414)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",415)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id")));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",416)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",417)
			obj->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",418)
		if (((bool((stack->length > (int)0)) && bool(((bool((inEvent->__Field(HX_CSTRING("value")) == (int)1)) || bool((inEvent->__Field(HX_CSTRING("value")) == (int)2)))))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",420)
			::nme::display::InteractiveObject obj1 = stack->__get((int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",421)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",422)
			obj1->nmeFireEvent(evt);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",423)
			if ((evt->nmeGetIsCancelled())){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",425)
				inEvent->__FieldRef(HX_CSTRING("result")) = (int)1;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",426)
				return null();
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",430)
		stack->reverse();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",432)
...
Void Stage_obj::nmeOnJoystick( Dynamic inEvent,::String inType){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",438)
		::nme::events::JoystickEvent evt = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",439)
		::String _switch_1 = (inType);
		if (  ( _switch_1==::nme::events::JoystickEvent_obj::AXIS_MOVE)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",442)
			Dynamic data = this->nmeJoyAxisData->get(inEvent->__Field(HX_CSTRING("id")));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",443)
			if (((data == null()))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",444)
				data = _Function_3_1::Block();
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",448)
			double value = (double(inEvent->__Field(HX_CSTRING("value"))) / double((int)32767));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",449)
			if (((value < (int)-1))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",449)
				value = (int)-1;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",451)
			switch( (int)(inEvent->__Field(HX_CSTRING("code")))){
				case (int)0: {
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",453)
					data->__FieldRef(HX_CSTRING("x")) = value;
				}
				;break;
				case (int)1: {
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",454)
					data->__FieldRef(HX_CSTRING("y")) = value;
				}
				;break;
				case (int)2: {
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",455)
					data->__FieldRef(HX_CSTRING("z")) = value;
				}
				;break;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",458)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",460)
			this->nmeJoyAxisData->set(inEvent->__Field(HX_CSTRING("id")),data);
		}
		else if (  ( _switch_1==::nme::events::JoystickEvent_obj::BALL_MOVE)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",462)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",466)
			int x = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",467)
			int y = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",469)
			if (((((int(inEvent->__Field(HX_CSTRING("value"))) & int((int)1))) != (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",470)
				y = (int)-1;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",473)
				if (((((int(inEvent->__Field(HX_CSTRING("value"))) & int((int)4))) != (int)0))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",474)
					y = (int)1;
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",478)
			if (((((int(inEvent->__Field(HX_CSTRING("value"))) & int((int)2))) != (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",479)
				x = (int)1;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",482)
				if (((((int(inEvent->__Field(HX_CSTRING("value"))) & int((int)8))) != (int)0))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",483)
					x = (int)-1;
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",487)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",489)
...
;
;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",492)
...
Void Stage_obj::nmeOnKey( Dynamic inEvent,::String inType){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",498)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",499)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id")));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",500)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",501)
			obj->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",502)
		if (((stack->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",504)
			::nme::display::InteractiveObject obj1 = stack->__get((int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",505)
			int flags = inEvent->__Field(HX_CSTRING("flags"));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",506)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",507)
			obj1->nmeFireEvent(evt);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",508)
			if ((evt->nmeGetIsCancelled())){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",509)
				inEvent->__FieldRef(HX_CSTRING("result")) = (int)1;
			}
		}
	}
...
Void Stage_obj::nmeOnMouse( Dynamic inEvent,::String inType,bool inFromMouse){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",516)
		::String type = inType;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",517)
		int button = inEvent->__Field(HX_CSTRING("value"));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",518)
		if ((!(inFromMouse))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",519)
			button = (int)0;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",520)
		int wheel = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",521)
		if (((inType == ::nme::events::MouseEvent_obj::MOUSE_DOWN))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",523)
			if (((button > (int)2))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",524)
				return null();
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",525)
			type = ::nme::display::Stage_obj::sDownEvents->__get(button);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",527)
			if (((inType == ::nme::events::MouseEvent_obj::MOUSE_UP))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",528)
				if (((button > (int)2))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",531)
					type = ::nme::events::MouseEvent_obj::MOUSE_WHEEL;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",532)
					wheel = (  (((button == (int)3))) ? int((int)1) : int((int)-1) );
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",536)
					type = ::nme::display::Stage_obj::sUpEvents->__get(button);
				}
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",539)
		if (((this->nmeDragObject != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",540)
			this->nmeDrag(::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x")),inEvent->__Field(HX_CSTRING("y"))));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",542)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",543)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id")));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",544)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",545)
			obj->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",547)
		::nme::geom::Point local = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",548)
		if (((stack->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",550)
			::nme::display::InteractiveObject obj1 = stack->__get((int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",551)
			stack->reverse();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",552)
			local = obj1->globalToLocal(::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x")),inEvent->__Field(HX_CSTRING("y"))));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",553)
			::nme::events::MouseEvent evt = ::nme::events::MouseEvent_obj::nmeCreate(type,inEvent,local,obj1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",554)
			evt->delta = wheel;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",555)
			if ((inFromMouse)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",556)
				this->nmeCheckInOuts(evt,stack,null());
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",557)
			obj1->nmeFireEvent(evt);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",562)
			local = ::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x")),inEvent->__Field(HX_CSTRING("y")));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",563)
			::nme::events::MouseEvent evt = ::nme::events::MouseEvent_obj::nmeCreate(type,inEvent,local,null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",564)
			evt->delta = wheel;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",565)
			if ((inFromMouse)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",566)
				this->nmeCheckInOuts(evt,stack,null());
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",569)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",570)
		if (((bool((inType == ::nme::events::MouseEvent_obj::MOUSE_DOWN)) && bool((button < (int)3))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",571)
			this->nmeLastDown[button] = click_obj;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",574)
			if (((bool((inType == ::nme::events::MouseEvent_obj::MOUSE_UP)) && bool((button < (int)3))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",576)
				if (((click_obj == this->nmeLastDown->__get(button)))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",578)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",579)
					click_obj->nmeFireEvent(evt);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",581)
					if (((bool((button == (int)0)) && bool(click_obj->doubleClickEnabled)))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",583)
						double now = ::haxe::Timer_obj::stamp();
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",584)
						if ((((now - this->nmeLastClickTime) < 0.25))){
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",586)
							...
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",587)
							click_obj->nmeFireEvent(evt1);
						}
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",589)
						this->nmeLastClickTime = now;
					}
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",592)
...
Void Stage_obj::nmeOnResize( double inW,double inH){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",599)
		::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::RESIZE,null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",600)
		this->nmeDispatchEvent(evt);
	}
return null();
}
...
Void Stage_obj::nmeOnTouch( Dynamic inEvent,::String inType,::nme::display::TouchInfo touchInfo){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",606)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",607)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id")));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",608)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",609)
			obj->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",611)
		if (((stack->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",613)
			::nme::display::InteractiveObject obj1 = stack->__get((int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",614)
			stack->reverse();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",615)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",616)
			::nme::events::TouchEvent evt = ::nme::events::TouchEvent_obj::nmeCreate(inType,inEvent,local,obj1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",617)
			evt->touchPointID = inEvent->__Field(HX_CSTRING("value"));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",618)
			evt->isPrimaryTouchPoint = (((int(inEvent->__Field(HX_CSTRING("flags"))) & int((int)32768))) > (int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",620)
			this->nmeCheckInOuts(evt,stack,touchInfo);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",621)
			obj1->nmeFireEvent(evt);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",622)
			if (((bool(evt->isPrimaryTouchPoint) && bool((inType == ::nme::events::TouchEvent_obj::TOUCH_MOVE))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",624)
				if (((this->nmeDragObject != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",625)
					this->nmeDrag(::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x")),inEvent->__Field(HX_CSTRING("y"))));
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",627)
				::nme::events::MouseEvent evt1 = ::nme::events::MouseEvent_obj::nmeCreate(::nme::events::MouseEvent_obj::MOUSE_MOVE,inEvent,local,obj1);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",628)
				obj1->nmeFireEvent(evt1);
			}
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",634)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",635)
			evt->touchPointID = inEvent->__Field(HX_CSTRING("value"));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",636)
			evt->isPrimaryTouchPoint = (((int(inEvent->__Field(HX_CSTRING("flags"))) & int((int)32768))) > (int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",638)
			this->nmeCheckInOuts(evt,stack,touchInfo);
		}
	}
return null();
...
Void Stage_obj::nmePollTimers( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",649)
		::haxe::Timer_obj::nmeCheckTimers();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",650)
		::nme::media::SoundChannel_obj::nmePollComplete();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",651)
		::nme::net::URLLoader_obj::nmePollData();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",652)
		this->nmeCheckRender();
	}
return null();
}
...
Void Stage_obj::nmeRender( bool inSendEnterFrame){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",661)
		if ((!(this->active))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",662)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",665)
		if ((inSendEnterFrame)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",666)
			this->nmeBroadcast(::nme::events::Event_obj::__new(::nme::events::Event_obj::ENTER_FRAME,null(),null()));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",669)
		if ((this->nmeInvalid)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",671)
			this->nmeInvalid = false;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",672)
			this->nmeBroadcast(::nme::events::Event_obj::__new(::nme::events::Event_obj::RENDER,null(),null()));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",674)
...
Void Stage_obj::nmeSetActive( bool inActive){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",682)
		if (((inActive != this->active))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",686)
			this->active = inActive;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",687)
			if ((!(this->active))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",688)
				this->nmeLastRender = ::haxe::Timer_obj::stamp();
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",690)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",691)
			this->nmeBroadcast(evt);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",692)
			if ((inActive)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",693)
				this->nmePollTimers();
			}
		}
	}
...
Void Stage_obj::nmeStartDrag( ::nme::display::Sprite sprite,bool lockCenter,::nme::geom::Rectangle bounds){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",703)
		this->nmeDragBounds = (  (((bounds == null()))) ? ::nme::geom::Rectangle(null()) : ::nme::geom::Rectangle(bounds->clone()) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",704)
		this->nmeDragObject = sprite;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",706)
		if (((this->nmeDragObject != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",707)
			if ((lockCenter)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",710)
				this->nmeDragOffsetX = (double(-(this->nmeDragObject->nmeGetWidth())) / double((int)2));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",711)
				this->nmeDragOffsetY = (double(-(this->nmeDragObject->nmeGetHeight())) / double((int)2));
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",715)
				::nme::geom::Point mouse = ::nme::geom::Point_obj::__new(this->nmeGetMouseX(),this->nmeGetMouseY());
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",716)
				::nme::display::DisplayObjectContainer p = this->nmeDragObject->nmeGetParent();
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",717)
				if (((p != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",718)
					mouse = p->globalToLocal(mouse);
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",720)
				this->nmeDragOffsetX = (this->nmeDragObject->nmeGetX() - mouse->x);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",721)
...
Void Stage_obj::nmeStopDrag( ::nme::display::Sprite sprite){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",732)
		this->nmeDragBounds = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",733)
...
double Stage_obj::nmeUpdateNextWake( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",743)
	double next_wake = ::haxe::Timer_obj::nmeNextWake(315000000.0);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",744)
	if (((bool((next_wake > 0.02)) && bool(((bool(::nme::media::SoundChannel_obj::nmeCompletePending()) || bool(::nme::net::URLLoader_obj::nmeLoadPending()))))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",745)
		next_wake = (  (((bool(this->active) || bool(!(this->pauseWhenDeactivated))))) ? double(0.020) : double(0.500) );
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",748)
	next_wake = this->nmeNextFrameDue(next_wake);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",749)
	::nme::display::Stage_obj::nme_stage_set_next_wake(this->nmeHandle,next_wake);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",750)
	return next_wake;
}
...
Void Stage_obj::showCursor( bool inShow){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",768)
...
::nme::display::StageAlign Stage_obj::nmeGetAlign( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",780)
	int i = ::nme::display::Stage_obj::nme_stage_get_align(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",781)
...
::nme::display::StageAlign Stage_obj::nmeSetAlign( ::nme::display::StageAlign inMode){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",787)
	::nme::display::Stage_obj::nme_stage_set_align(this->nmeHandle,inMode->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",788)
	return inMode;
}
...
::nme::display::StageDisplayState Stage_obj::nmeGetDisplayState( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",794)
	int i = ::nme::display::Stage_obj::nme_stage_get_display_state(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",795)
...
::nme::display::StageDisplayState Stage_obj::nmeSetDisplayState( ::nme::display::StageDisplayState inState){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",801)
	::nme::display::Stage_obj::nme_stage_set_display_state(this->nmeHandle,inState->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",802)
	return inState;
}
...
double Stage_obj::nmeGetDPIScale( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",807)
...
::nme::display::InteractiveObject Stage_obj::nmeGetFocus( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",814)
	int id = ::nme::display::Stage_obj::nme_stage_get_focus_id(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",815)
	::nme::display::DisplayObject obj = this->nmeFindByID(id);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",816)
	return obj;
}
...
::nme::display::InteractiveObject Stage_obj::nmeSetFocus( ::nme::display::InteractiveObject inObject){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",822)
	if (((inObject == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",823)
		::nme::display::Stage_obj::nme_stage_set_focus(this->nmeHandle,null(),(int)0);
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",825)
		::nme::display::Stage_obj::nme_stage_set_focus(this->nmeHandle,inObject->nmeHandle,(int)0);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",826)
	return inObject;
}
...
double Stage_obj::nmeSetFrameRate( double inRate){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",832)
	this->frameRate = inRate;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",833)
	this->nmeFramePeriod = (  (((this->frameRate <= (int)0))) ? double(this->frameRate) : double((double(1.0) / double(this->frameRate))) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",834)
	return inRate;
}
...
bool Stage_obj::nmeIsOpenGL( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",839)
...
::nme::display::StageQuality Stage_obj::nmeGetQuality( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",846)
	int i = ::nme::display::Stage_obj::nme_stage_get_quality(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",847)
...
::nme::display::StageQuality Stage_obj::nmeSetQuality( ::nme::display::StageQuality inQuality){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",853)
	::nme::display::Stage_obj::nme_stage_set_quality(this->nmeHandle,inQuality->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",854)
	return inQuality;
}
...
::nme::display::StageScaleMode Stage_obj::nmeGetScaleMode( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",860)
	int i = ::nme::display::Stage_obj::nme_stage_get_scale_mode(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",861)
...
::nme::display::StageScaleMode Stage_obj::nmeSetScaleMode( ::nme::display::StageScaleMode inMode){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",867)
	::nme::display::Stage_obj::nme_stage_set_scale_mode(this->nmeHandle,inMode->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",868)
	return inMode;
}
...
bool Stage_obj::nmeGetStageFocusRect( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",872)
...
bool Stage_obj::nmeSetStageFocusRect( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",875)
	::nme::display::Stage_obj::nme_stage_set_focus_rect(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",876)
	return inVal;
}
...
int Stage_obj::nmeGetStageHeight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",881)
...
int Stage_obj::nmeGetStageWidth( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",887)
...
int run(){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",110)
...
Void Stage_obj::setFixedOrientation( int inOrientation){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",755)
...
bool run(int inOrientation){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,0/nme/display/Stage.hx",762)
